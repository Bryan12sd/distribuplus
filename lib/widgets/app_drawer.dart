    ...
    return Drawer(
      child: ListView(
        ...
        children: [
          ...
          /*  _drawerItem(
              context, Icons.inventory, 'Inventario', const InventoryScreen()),
          _drawerItem(
              context, Icons.shopping_cart, 'Ventas', const SalesScreen()),
          _drawerItem(
              context, Icons.bar_chart, 'Reportes', const ReportsScreen()),
